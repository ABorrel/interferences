...
multipleHisthepg2 = function(d, prout){
  ...
  # med red n#
  ggplot(d, aes(x=-log10(med_red_n))) + 
    geom_histogram(aes(y=..density..),     # Histogram with density instead of count on y-axis
                   binwidth=.5,
                   colour="black", fill="white") +
    labs(x = "-log10(AC50)", y = "Frequencies") + 
    ...
    theme(axis.text.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.text.x = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.x =  element_text(size = 25, hjust = 0.5, vjust =0.1))+
    geom_density(alpha=.2, fill="#c70000")
  ggsave(paste(prout, "med_red_n.png", sep = ""), dpi = 300, width = 8, height = 7)
  ...
  # med green n
  ggplot(d, aes(x=-log10(med_green_n))) + 
    geom_histogram(aes(y=..density..),     # Histogram with density instead of count on y-axis
                   binwidth=.5,
                   colour="black", fill="white") +
    labs(x = "-log10(AC50)", y = "Frequencies") + 
    ...
    theme(axis.text.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.text.x = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.x =  element_text(size = 25, hjust = 0.5, vjust =0.1))+
    geom_density(alpha=.2, fill="#0e12df")
  ggsave(paste(prout, "med_green_n.png", sep = ""), dpi = 300, width = 8, height = 7)
  ...
  # cell green n
  ggplot(d, aes(x=-log10(cell_green_n))) + 
    geom_histogram(aes(y=..density..),     # Histogram with density instead of count on y-axis
                   binwidth=.5,
                   colour="black", fill="white") +
    labs(x = "-log10(AC50)", y = "Frequencies") + 
    ...
    theme(axis.text.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.text.x = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.x =  element_text(size = 25, hjust = 0.5, vjust =0.1))+
    geom_density(alpha=.2, fill="#7af4c3")
  ggsave(paste(prout, "cell_green_n.png", sep = ""), dpi = 300, width = 8, height = 7)
  ...
  # cell_red_n
  ggplot(d, aes(x=-log10(cell_red_n))) + 
    geom_histogram(aes(y=..density..),     # Histogram with density instead of count on y-axis
                   binwidth=.5,
                   colour="black", fill="white") +
    labs(x = "-log10(AC50)", y = "Frequencies") + 
    ...
    theme(axis.text.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.text.x = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.y = element_text(size = 25, hjust = 0.5, vjust =0.1), axis.title.x =  element_text(size = 25, hjust = 0.5, vjust =0.1))+
    geom_density(alpha=.2, fill="#e3230d")
  ggsave(paste(prout, "cell_red_n.png", sep = ""), dpi = 300, width = 8, height = 7)
...
combinehepg2hist = function(d, prout){
  ...
  # combine plot with n
  dmed_red_n = cbind(d$med_red_n, rep("med_red_n", length(d$med_red_n)))
  dmed_blue_n = cbind(d$med_blue_n, rep("med_blue_n", length(d$med_blue_n)))
  dmed_green_n = cbind(d$med_green_n, rep("med_green_n", length(d$med_green_n)))
  dcell_green_n = cbind(d$cell_green_n, rep("cell_green_n", length(d$cell_green_n)))
  dcell_blue_n = cbind(d$cell_blue_n, rep("cell_blue_n", length(d$cell_blue_n)))
  dcell_red_n = cbind(d$cell_red_n, rep("cell_red_n", length(d$cell_red_n)))
  
  
  din = rbind(dmed_red_n, dmed_blue_n)
  din = rbind(din, dmed_green_n)
  din = rbind(din, dcell_green_n)
  din = rbind(din, dcell_blue_n)
  din = rbind(din, dcell_red_n)
  ...
  ggsave(paste(prout, "combine_n.png", sep = ""), dpi = 300, width = 8, height = 7)
